            ...
            <div className="flex justify-between items-center max-w-6xl mx-auto p-3">
                ...
                <ul className='flex gap-4'>
                    ...
                    <Link to={currentUser ? '/profile' : '/sign-in'}>
                        {
                            currentUser ? <img src={currentUser.avatar} alt="" className='rounded-full border border-slate-300 h-7 w-7 object-cover' /> : <li className={`inline text-sm sm:text-base ${location.pathname === '/sign-in' || location.pathname === '/sign-up' ? 'text-slate-100' : 'text-slate-300'}  hover:underline`}>Sign in</li>
                        }
